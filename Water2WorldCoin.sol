...
contract Water2WorldCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Water2WorldCoin() {
        ...
        name = "Water2WorldCoin";                                   // Set the name for display purposes (CHANGE THIS)
